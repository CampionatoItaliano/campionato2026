...
var teams = [];
    teams['team-toscana']={"name":"Team Toscana", "dacaricare":true, "icon":"img/toscana.png","url":"https://www.chess.com/club/team-toscana","puntiTotali":0,"puntiSpareggio":0, "posizione":0,  "puntiConclusi":0, "teamVinte" : [], "teamPatte" : [], "albo1":0, "albo2":0, "albo3":0, "puntiAlbo":0, "posizioneAlbo":0};
    ...
    teams['team-piemonte']={"name":"Team Piemonte", "dacaricare":true,  "icon":"https://images.chesscomfiles.com/uploads/v1/group/27066.cea76db9.160x160o.9327ace4b6aa.gif","url":"https://www.chess.com/club/team-piemonte","puntiTotali":0,"puntiSpareggio":0, "posizione":0,  "puntiConclusi":0, "teamVinte" : [], "teamPatte" : [], "albo1":0, "albo2":0, "albo3":0, "puntiAlbo":0, "posizioneAlbo":0};
    ...
    teams['lazio']={"name":"Lazio", "dacaricare":true,  "icon":"https://images.chesscomfiles.com/uploads/v1/group/79686.3bef8c7c.160x160o.51a2f9005768.png","url":"https://www.chess.com/club/lazio","puntiTotali":0,"puntiSpareggio":0, "posizione":0,  "puntiConclusi":0, "teamVinte" : [], "teamPatte" : [], "albo1":0, "albo2":0, "albo3":0, "puntiAlbo":0, "posizioneAlbo":0};
    ...
    teams['team-calabria']={"name":"Team Calabria", "dacaricare":true,  "icon":"https://images.chesscomfiles.com/uploads/v1/group/4648.67ad5f2a.160x160o.c41d6f6e39e4.png","url":"https://www.chess.com/club/team-calabria","puntiTotali":0,"puntiSpareggio":0, "posizione":0,  "puntiConclusi":0, "teamVinte" : [], "teamPatte" : [], "albo1":0, "albo2":0, "albo3":0, "puntiAlbo":0, "posizioneAlbo":0};
...
function caricaMatch(index, url)
{
    ...
    {
        if (!matchs[index].daCaricare) //Se non giocata
        {
            matchs[index].iscritti1 = 0;   //Serve per partite in partenza
            matchs[index].iscritti2 = 0;   //Serve per partite in partenza

            matchs[index].boards = 1;
            matchs[index].score1 = matchs[index].punti1;
            matchs[index].score2 = matchs[index].punti2;
            if (matchs[index].punti1 > matchs[index].punti2) 
            {
                matchs[index].punti1 ++;
                teams[matchs[index].team1].teamVinte.push(matchs[index].team2);
                teams[matchs[index].team1].puntiTotali ++;
            }    
            if (matchs[index].punti1 < matchs[index].punti2) 
            {
                matchs[index].punti2 ++;
                teams[matchs[index].team2].teamVinte.push(matchs[index].team1);
                teams[matchs[index].team2].puntiTotali ++;
            }            

            matchs[index].concluso = true;   //Per colore in tabella
            //Aggiorno punti solo conclusi
            teams[matchs[index].team1].puntiConclusi += matchs[index].punti1;  
            teams[matchs[index].team2].puntiConclusi += matchs[index].punti2;
